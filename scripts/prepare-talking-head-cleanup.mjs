...
function usage() {
  return [
    ...
    "  --transcriber <provider>      elevenlabs|openai|gemini|external. Default: VIDEO_WORKFLOW_TRANSCRIBE_PROVIDER or elevenlabs.",
    "  --transcribe-model <id>       Provider model override. Defaults: scribe_v1, whisper-1, gemini-3-flash-preview.",
...
function parseArgs(argv) {
  const args = {
    ...
    language: "",
    numSpeakers: "",
    transcriber: process.env.VIDEO_WORKFLOW_TRANSCRIBE_PROVIDER || "elevenlabs",
    transcribeModel: "",
    transcripts: [],
